...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
	...
	<body>
		<div class="site-header bg-dark pt-5">
      <div class="container">
        <div class="row">
      ...
      <div class="container">
        <div class="row">
          <div class="col-5 pt-5">
            ...
            <p class="mb-4 text-secondary">Lorem ipsum dolor sit amet consectetur adipisicing elit. Cum, ipsum officia? Saepe reiciendis sit asperiores molestiae, porro tempora dolorum iusto harum ea.</p>
    ...
    <div class="site-footer text-white pb-5">
      <div class="container">
        <img src="/images/logo.png" class="mb-4" height="50" alt="Instituto Avançar">
        <div class="row">
          <div class="col-4">
